    ...
    function loadofta(page){
        var parametros = {"action":"ajax","page":page};
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'bloques/consultas/historial_oftalmo.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loader").html("");
            },
            success:function(data){
                $(".h_ofta").html(data).fadeIn('slow');
                $("#loader").html("");
            }
        })
    }

    function loadped(page){
        var parametros = {"action":"ajax","page":page};
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'bloques/consultas/historial_pediatria.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loader").html("");
            },
            success:function(data){
                $(".h_ped").html(data).fadeIn('slow');
                $("#loader").html("");
            }
        })
    }

function loadenf(page){
        var parametros = {"action":"ajax","page":page};
        $("#loader").fadeIn('slow');
        $.ajax({
            url:'bloques/consultas/signos_vitales.php',
            data: parametros,
             beforeSend: function(objeto){
            $("#loader").html("");
            },
            success:function(data){
                $(".h_enf").html(data).fadeIn('slow');
                $("#loader").html("");
            }
        })
    }
    ...
    function guardarHistorialPed(){ 
        var datos=$('#form_historial').serialize();
        var id_vacio=$('#id_historial').val();
        if (id_vacio=="") {
            $.ajax({
                type:"POST",
                url:"db/guardar_datos_ped.php",
                data:datos,
                success:function(r){
                        load(1);
                        loadofta(1);
