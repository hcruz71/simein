					...
					<div class="panel-body">
					    <form id="form_login">
							<img src="assets/images/logo_login.jpg" class="img-responsive center-block" alt="Image" style="max-width: 200px;">
						   	<p class="lead text-center"><strong>Iniciar Sesión cuestionario primera vez</strong></p>
						   	...
						   	<button id="btn_login_cu" class="btn btn-primary btn-block">Entrar</button>
					    </form>
						<div>
	...
	$('#btn_login_cu').click(function(){
            ...
            $.ajax({
                ...
                success:function(r){
					...
					if(r.resp=='1'){  //CUESTIONARIO POR DEFECTO
                    	$('#alert').html("Los datos son correctos    ¡Bienvenido!");
                    	$('.alert').css("background-color", "#76cc96");
                    	$('.alert').css("color", "#fff");
						location.href='historial_clinico.php';
					}
					
					if(r.resp=='2'){  //CUESTIONARIO PARA SPORTKINES
                    	$('#alert').html("Los datos son correctos    ¡Bienvenido!");
                    	$('.alert').css("background-color", "#76cc96");
                    	$('.alert').css("color", "#fff");
						location.href='cuestionario_sportkines.php';
                    }
                }
            });
