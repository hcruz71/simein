...
$id_doctor=$_SESSION['id_usuario'];
    ...
    if($action == 'ajax'){
        ...
        $sql = mysqli_query($conexion,"SELECT * FROM historial_clinico where id_doctor=$id_doctor and id_paciente=$id_pac_get and activo=1 ORDER BY id DESC LIMIT $offset,$per_page ");
        $query = $pdo->prepare($sql);
        $query->execute();
                                            ...
                                            <div class="border-top">
                                                <div class="row" id="signos_vitales">
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="temperatura" id="temperatura" value="<?php echo $row['temperatura'];?>">
                                                    ...
                                                    <div class="col-md-3">
                                                            <label>Peso</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="peso" id="peso" value="<?php echo $row['peso'];?>">
                                                    ...
                                                    <div class="col-md-3">
                                                            <label>Talla</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="talla" id="talla" value="<?php echo $row['talla'];?>">
                                                    ...
                                                    <div class="col-md-3">
                                                            <label>IMC</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="imc" id="imc" value="<?php echo $row['imc'];?>">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                            <label>FC.</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="fc" id="fc" value="<?php echo $row['fc'];?>">
                                                    ...
                                                    <div class="col-md-3">
                                                            <label>FR</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="fr" id="fr" value="<?php echo $row['fr'];?>">
                                                            <div class="input-group-append"><span class="input-group-text"></span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                            <label>TA</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="ta" id="ta" value="<?php echo $row['ta'];?>">
                                                            <div class="input-group-append"><span class="input-group-text"></span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                            <label>semanas</label>
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" name="semanas" id="semanas" value="<?php echo $row['semanas'];?>">
                                                            <div class="input-group-append"><span class="input-group-text fa fa-calculator"></span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <h3>&nbsp;&nbsp;Recetas</h3>
                                                   <!-- <input type="submit" name="">
                                                    ...
                                                    <form action="print/receta_1.php" method="POST" target="_blank">
                                                        ...
                                                        <div style="float: right;" >
                                                            ...
                                                            <textarea name="receta_print" class="receta_print" rows="1" hidden="false"><?php echo $row['receta'];?></textarea>
                                                    ...
                                                    <textarea class="form-control" name="receta" id="txt_recetas" rows="5" class=""><?php echo $row['receta'];?></textarea>
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="formato" value="<?php echo $res['id_template']; ?>" hidden="false">

                                                            <textarea name="receta_print" class="receta_print" rows="1" hidden="false"><?php echo $row['receta'];?></textarea>

                                                            <button type="submit" name="btn_receta_1" class="btn btn-default"><i class="fa fa-print" ></i>&nbsp;<?php echo $res['descripcion']; ?></button>
        ...
        <div class="border-top">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                        <label>FR</label>
                    <div class="input-group">
                        <input type="number" class="form-control" name="fr" id="fr">
                        <div class="input-group-append"><span class="input-group-text"></span></div>
                    </div>
                </div>
                <div class="col-md-2">
                        <label>TA</label>
                    <div class="input-group">
                        <input type="number" class="form-control" name="ta" id="ta">
                        <div class="input-group-append"><span class="input-group-text"></span></div>
                    </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                        <label>semanas</label>
                    <div class="input-group">
                        <input type="number" class="form-control" name="semanas" id="semanas" >
                        <div class="input-group-append"><span class="input-group-text fa fa-calculator"></span></div>
                    </div>
                </div>
            </div>
                   ...
                   <input type="submit" name="">
                    ...
                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <textarea name="receta_print" class="receta_print" rows="1" hidden="false"></textarea>
...
// BUSCADOR MED
    ...
    function imprimir_receta(id_template_print){ 
        var id_template_print = id_template_print;
        var receta=$('#med').val();
        var id_paciente=$('#id_paciente').val();
        $.ajax({  
                url:"print/receta_print.php",  
                method:"POST",  
                data:{
                    id_template_print:id_template_print,
                    receta_print:receta,
                    id_paciente_receta:id_paciente,

                },   
                success:function(data){  
                    $('#div1').html(data);
                    //location.href="print/receta_print.php";
