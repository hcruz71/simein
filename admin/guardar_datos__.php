 ...
 {  
  ...
  $fecha=date('y-m-d');
    ...
    if ($id_doctor_add=="") {
      ...
      $sentencia_doc="INSERT INTO doctor(id_doctor, nombre, id_asesor, correo, celular, direccion, rol, id_especialidad, id_alergicos, id_hf, id_pp, id_np, id_go, id_padecimiento, id_signos_vitales, id_diagnosticos, id_archivos) VALUES ('$row1', '$nombre_doctor', '$id_coordinador', '$correo_doctor', '$celular_doctor', '$domicilio_doctor', '1', '$id_especialidad', '1', '1', '1', '1', '1', '1', '1', '1', '1')";
      $resent_doc=mysqli_query($conexion,$sentencia_doc);
