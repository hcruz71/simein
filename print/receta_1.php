...
$id_doctor=$_SESSION['id_usuario'];
    ...
    $query_doc = "SELECT * FROM templates_recetas where id_doctor=$id_doctor and id_template=$formato";
...
?>
    ...
    <div style="position:absolute;font-size:<?php echo $font_size ?>px;right:<?php echo $fecha_right ?>px;top:<?php echo $fecha_top ?>px;"><?php echo $fecha ?></div>
    <div style="position:absolute;font-size:<?php echo $font_size ?>px;left:<?php echo $nom_left ?>px;top:<?php echo $nom_top ?>px;"><?php echo $nom_paciente ?> </div>
    <div style="position:absolute;font-size:<?php echo $font_size ?>px;left:<?php echo $rec_left ?>px;top:<?php echo $rec_top ?>px;"><?php echo $receta ?></div>
