...
//$fecha_receta=$fecha_dia.''.$fecha_mes.''.$fecha_ano;
    ...
    require '../conexion_i.php';
        $sql_pac="SELECT * FROM pacientes where id_doctor=$id_doctor and id_Paciente=1";
...
<div id="div_rec" style="border: none;">
    <div class="row">
        ...
        <div class="col-md-2">
            <img src="../assets/images/logo_login.jpg" class="img-responsive" style="max-width: 150px">
        </div>
    ...
    <div class="row" style="font-size: 20px">
        ...
        <div class="col-md-10" style="border: 3px solid #28defa; border-radius: 15px; height: 500px">
            ...
            <div class="container"><b>Rx</b><pre style="border: none;"><?php echo '$receta' ?></pre></div>
         </div>
    </div>
