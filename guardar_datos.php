 <?php 
    ...
    if (isset($_POST['prefijo'])) {
        ...
        $sentencia="update doctor set atencion='$prefijo', celular='$celular', telefono='$telefono', telefono='$telefono', direccion='$direccion', correo='$correo' where id_doctor='$id_doctor'";
        $resent=mysqli_query($conexion,$sentencia);
        echo "update doctor";
    }
